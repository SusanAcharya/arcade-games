          ...
          var __webpack_modules__ = [
                ...
                return (function(moduleArg = {}) {
                      ...
                      if (a()) {
                        ...
                        if (b.canvas) {
                          ...
                          for (const H of r) {
                            ...
                            H.mc ? (b.scissor(H.Za, M - H.$a - H.kb, H.Ac, H.kb), ea = true) : ea && (b.scissor(0, M - t, k, t), ea = false);
                            r = 2 / k;
                            const da = -2 / t;
                  ...
                  m.onRuntimeInitialized = function() {
                    ...
                    var t = m.RenderImage.extend("CanvasRenderImage", { __construct: function({ la: q, xa: x } = {}) {
                      ...
                      this.ja = { zb: q, Ab: x, cb: F, eb: I, Ra: [], ec: true };
                    ...
                    m.RendererWrapper.prototype.align = function(q, x, F, I, B = 1) {
                  ...
                  var Aa, z, Ba = false, C, E, Ca, Da, L, N, Ea, Fa;
                  function Ia() {
                    var a = Aa.buffer;
                  ...
                  var Db = null, Eb = {}, Fb = [], Gb = 1, Hb = null, Ib = true, O = null, Ab = {}, Kb = (a, b = {}) => {
                    a = kb(a);
                    if (!a) {
                      return { path: "", node: null };
                    }
                    b = Object.assign({ hb: true, Qa: 0 }, b);
                    if (8 < b.Qa) {
                      throw new O(32);
                    }
                    ...
                    if (b & 512 && !d) {
                      c = e;
                      c = "string" == typeof c ? Kb(c, { gb: true }).node : c;
                      if (!c.l.P) {
                        throw new O(63);
                      }
                    ...
                    b &= -131713;
                    e = Ub({ node: e, path: Lb(e), flags: b, seekable: true, position: 0, m: e.m, zc: [], error: false });
                    e.m.open && e.m.open(e);
                  ...
                  S.M.push({ value: void 0 }, { value: null }, { value: true }, { value: false });
                  S.h = S.M.length;
                  ...
                  var Xd = { __syscall_fcntl64: function(a, b, c) {
                    ...
                    try {
                      ...
                      var f = Sb(a);
                      fc(f, b, d);
                      Za = [f.position >>> 0, (Ya = f.position, 1 <= +Math.abs(Ya) ? 0 < Ya ? +Math.floor(Ya / 4294967296) >>> 0 : ~~+Math.ceil((Ya - +(~~Ya >>> 0)) / 4294967296) >>> 0 : 0)];
                      L[e >> 2] = Za[0];
                      L[e + 4 >> 2] = Za[1];
                  ...
                  function $d() {
                    function a() {
                      if (!Yd && (Yd = true, m.calledRun = true, !Ba)) {
            ...
            ((__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
              ...
              __webpack_require__2.d(__webpack_exports__2, {
                ...
                Finalizable: () => (
                  /* reexport safe */
                  _finalizationRegistry__WEBPACK_IMPORTED_MODULE_2__.Finalizable
                ),
                /* harmony export */
                FontAssetWrapper: () => (
                  /* reexport safe */
